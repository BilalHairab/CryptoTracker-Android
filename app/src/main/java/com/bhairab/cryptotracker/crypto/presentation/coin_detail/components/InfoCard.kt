package com.bhairab.cryptotracker.crypto.presentation.coin_detail.components
...
fun InfoCard(
    ...
    val defaultTextStyle = LocalTextStyle.current.copy(textAlign = TextAlign.Center, fontSize = 18.sp, color = contentColor)
    Card(
        modifier = modifier
            .padding(8.dp)
            .shadow(
